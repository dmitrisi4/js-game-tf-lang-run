...
export const TENERIFE_FULL_ISLAND_WATER_SURFACE_Y = -0.18;
export const TENERIFE_FULL_ISLAND_SEABED_Y = -7.5;
export const TENERIFE_FULL_ISLAND_DEEP_WATER_RESET_Y = -5.5;
...
export const TENERIFE_FULL_ISLAND_PUERTO_START_POSITION = new Vector3(-627, 75, -12);
